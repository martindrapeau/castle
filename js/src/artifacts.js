(function() {
  ...
  buildBreakableTile("a-crate", 46);
  buildBreakableTile("a-crate-coin", 46, {artifact: "a-coin"});
  buildBreakableTile("a-crate-coin-bag", 46, {artifact: "a-coin-bag"});
  buildBreakableTile("a-crate-key", 46, {artifact: "a-key"});
  buildBreakableTile("a-crate-red-potion", 46, {artifact: "a-red-potion"});
  buildBreakableTile("a-crate-health", 46, {artifact: "a-health"});
  buildBreakableTile("a-crate-death", 46, {artifact: "a-death"});
  buildBreakableTile("a-crate-spider", 46, {artifact: "spider"});
  buildBreakableTile("a-barrel", 45);
  buildBreakableTile("a-barrel-coin", 45, {artifact: "a-coin"});
  buildBreakableTile("a-barrel-key", 45, {artifact: "a-key"});
  buildBreakableTile("a-barrel-green-potion", 45, {artifact: "a-green-potion"});
  buildBreakableTile("a-barrel-health", 45, {artifact: "a-health"});
  buildBreakableTile("a-barrel-death", 45, {artifact: "a-death"});
  buildBreakableTile("a-barrel-spider", 45, {artifact: "spider"});
  buildBreakableTile("a-hay", 65);
  buildBreakableTile("a-hay-coin", 65, {artifact: "a-coin"});
  buildBreakableTile("a-hay-key", 65, {artifact: "a-key"});
  buildBreakableTile("a-hay-red-potion", 65, {artifact: "a-red-potion"});
  buildBreakableTile("a-hay-health", 65, {artifact: "a-health"});
  buildBreakableTile("a-hay-death", 65, {artifact: "a-death"});
  buildBreakableTile("a-hay-spider", 65, {artifact: "spider"});
  buildBreakableTile("a-chess", 47);
  buildBreakableTile("a-chess-coin", 47, {artifact: "a-coin"});
  buildBreakableTile("a-chess-coin-bag", 47, {artifact: "a-coin-bag"});
  buildBreakableTile("a-chess-key", 47, {artifact: "a-key"});
  buildBreakableTile("a-chess-red-potion", 47, {artifact: "a-red-potion"});
  buildBreakableTile("a-chess-health", 47, {artifact: "a-health"});
  buildBreakableTile("a-chess-death", 47, {artifact: "a-death"});
  buildBreakableTile("a-chess-spider", 47, {artifact: "spider"});
  buildBreakableTile("a-block", 29);
  buildBreakableTile("a-block-coin", 29, {artifact: "a-coin"});
  buildBreakableTile("a-block-coin-bag", 29, {artifact: "a-coin-bag"});
  buildBreakableTile("a-block-key", 29, {artifact: "a-key"});
  buildBreakableTile("a-block-red-potion", 29, {artifact: "a-red-potion"});
  buildBreakableTile("a-block-health", 29, {artifact: "a-health"});
  buildBreakableTile("a-block-death", 29, {artifact: "a-death"});
  buildBreakableTile("a-block-spider", 29, {artifact: "spider"});
  buildBreakableTile("a-vase", 51, {paddingTop: 14});
  buildBreakableTile("a-vase-coin", 51, {artifact: "a-coin", paddingTop: 14});
  buildBreakableTile("a-vase-coin-bag", 51, {artifact: "a-coin-bag", paddingTop: 14});
  buildBreakableTile("a-vase-key", 51, {artifact: "a-key", paddingTop: 14});
  buildBreakableTile("a-vase-red-potion", 51, {artifact: "a-red-potion", paddingTop: 14});
  buildBreakableTile("a-vase-health", 51, {artifact: "a-health", paddingTop: 14});
  buildBreakableTile("a-vase-death", 51, {artifact: "a-death", paddingTop: 14});
  buildBreakableTile("a-vase-spider", 51, {artifact: "spider", paddingTop: 14});
