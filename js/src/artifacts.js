(function() {
  ...
  buildBreakableTile("a-crate", 54);
  buildBreakableTile("a-crate-coin", 54, {artifact: "a-coin"});
  buildBreakableTile("a-crate-coin-bag", 54, {artifact: "a-coin-bag"});
  buildBreakableTile("a-crate-key", 54, {artifact: "a-key"});
  buildBreakableTile("a-crate-red-potion", 54, {artifact: "a-red-potion"});
  buildBreakableTile("a-crate-health", 54, {artifact: "a-health"});
  buildBreakableTile("a-crate-death", 54, {artifact: "a-death"});
  buildBreakableTile("a-crate-spider", 54, {artifact: "spider"});
  buildBreakableTile("a-barrel", 56);
  buildBreakableTile("a-barrel-coin", 56, {artifact: "a-coin"});
  buildBreakableTile("a-barrel-key", 56, {artifact: "a-key"});
  buildBreakableTile("a-barrel-green-potion", 56, {artifact: "a-green-potion"});
  buildBreakableTile("a-barrel-health", 56, {artifact: "a-health"});
  buildBreakableTile("a-barrel-death", 56, {artifact: "a-death"});
  buildBreakableTile("a-barrel-spider", 56, {artifact: "spider"});
  buildBreakableTile("a-hay", 66);
  buildBreakableTile("a-hay-coin", 66, {artifact: "a-coin"});
  buildBreakableTile("a-hay-key", 66, {artifact: "a-key"});
  buildBreakableTile("a-hay-red-potion", 66, {artifact: "a-red-potion"});
  buildBreakableTile("a-hay-health", 66, {artifact: "a-health"});
  buildBreakableTile("a-hay-death", 66, {artifact: "a-death"});
  buildBreakableTile("a-hay-spider", 66, {artifact: "spider"});
  buildBreakableTile("a-chess", 46);
  buildBreakableTile("a-chess-coin", 46, {artifact: "a-coin"});
  buildBreakableTile("a-chess-coin-bag", 46, {artifact: "a-coin-bag"});
  buildBreakableTile("a-chess-key", 46, {artifact: "a-key"});
  buildBreakableTile("a-chess-red-potion", 46, {artifact: "a-red-potion"});
  buildBreakableTile("a-chess-health", 46, {artifact: "a-health"});
  buildBreakableTile("a-chess-death", 46, {artifact: "a-death"});
  buildBreakableTile("a-chess-spider", 46, {artifact: "spider"});
  buildBreakableTile("a-block", 45);
  buildBreakableTile("a-block-coin", 45, {artifact: "a-coin"});
  buildBreakableTile("a-block-coin-bag", 45, {artifact: "a-coin-bag"});
  buildBreakableTile("a-block-key", 45, {artifact: "a-key"});
  buildBreakableTile("a-block-red-potion", 45, {artifact: "a-red-potion"});
  buildBreakableTile("a-block-health", 45, {artifact: "a-health"});
  buildBreakableTile("a-block-death", 45, {artifact: "a-death"});
  buildBreakableTile("a-block-spider", 45, {artifact: "spider"});
  buildBreakableTile("a-vase", 34, {paddingTop: 14});
  buildBreakableTile("a-vase-coin", 34, {artifact: "a-coin", paddingTop: 14});
  buildBreakableTile("a-vase-coin-bag", 34, {artifact: "a-coin-bag", paddingTop: 14});
  buildBreakableTile("a-vase-key", 34, {artifact: "a-key", paddingTop: 14});
  buildBreakableTile("a-vase-red-potion", 34, {artifact: "a-red-potion", paddingTop: 14});
  buildBreakableTile("a-vase-health", 34, {artifact: "a-health", paddingTop: 14});
  buildBreakableTile("a-vase-death", 34, {artifact: "a-death", paddingTop: 14});
  buildBreakableTile("a-vase-spider", 34, {artifact: "spider", paddingTop: 14});
