(function() {
  ...
  buildBreakableTile("a-chess", 55);
  buildBreakableTile("a-chess-coin", 55, {artifact: "a-coin"});
  buildBreakableTile("a-chess-coin-bag", 55, {artifact: "a-coin-bag"});
  buildBreakableTile("a-chess-key", 55, {artifact: "a-key"});
  buildBreakableTile("a-chess-red-potion", 55, {artifact: "a-red-potion"});
  buildBreakableTile("a-chess-health", 55, {artifact: "a-health"});
  buildBreakableTile("a-chess-death", 55, {artifact: "a-death"});
  buildBreakableTile("a-chess-spider", 55, {artifact: "spider"});
